...
/**
 * JUnit 5 tests for the Conditional Formatting API — CF-* test cases.
 *
 * CF-01 to CF-07  : ConditionalFormattingCollection management — all pass now.
 * CF-10 to CF-1C  : FormatConditionCollection area/condition management — all pass now.
 * CF-20 to CF-30  : addCondition for each FormatConditionType — structural counts only.
 * CF-40 to CF-43  : Priority tests — @Disabled (no public read API yet).
 * CF-50 to CF-57  : FormatCondition property getters — @Disabled (UnsupportedOperationException).
 * CF-60 to CF-66  : XLSX serialisation — @Disabled.
 * CF-70 to CF-75  : XLSX round-trip / POI integration — @Disabled.
 */
class ConditionalFormattingTest {
    ...
    /** Shorthand: worksheet → its ConditionalFormattingCollection. */
    ...
    // =========================================================================
    // CF-15  removeArea(CellArea) subtracts overlapping region — 3 pieces remain
    //
    ...
    // =========================================================================
    // CF-30  Multiple conditions in one collection — count reflects all added
    // =========================================================================
