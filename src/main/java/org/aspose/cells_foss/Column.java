...
import org.aspose.cells_foss.core.ColumnRangeModel;
...
public final class Column {
    ...
    /** Returns the outline/group nesting level (0 = ungrouped, 1鈥?). */
    public int getGroupLevel() {
        ColumnRangeModel range = findRange();
        return range != null ? range.getOutlineLevel() : 0;
    }

    /** Sets the outline/group nesting level (0 = ungrouped, 1鈥?). */
