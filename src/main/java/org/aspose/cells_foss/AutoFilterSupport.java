...
public final class AutoFilterSupport {
    ...
    public static String normalizeRequiredRange(String value, String parameterName) {
        ...
        try {
            org.aspose.cells_foss.core.CellAddress.parse(firstPart);
        } catch (Exception e) {
     ...
     */
    public static org.aspose.cells_foss.core.AutoFilterModel.FilterOperatorType parseOperatorOrDefault(String value) {
        // Handle the relevant branch before the state changes.
        if (value == null || value.isBlank()) {
            return org.aspose.cells_foss.core.AutoFilterModel.FilterOperatorType.EQUAL;
        }

        String trimmed = value.trim();
        switch (trimmed) {
            case "lessThan":
                return org.aspose.cells_foss.core.AutoFilterModel.FilterOperatorType.LESS_THAN;
            case "lessThanOrEqual":
                return org.aspose.cells_foss.core.AutoFilterModel.FilterOperatorType.LESS_OR_EQUAL;
            case "notEqual":
                return org.aspose.cells_foss.core.AutoFilterModel.FilterOperatorType.NOT_EQUAL;
            case "greaterThanOrEqual":
                return org.aspose.cells_foss.core.AutoFilterModel.FilterOperatorType.GREATER_OR_EQUAL;
            case "greaterThan":
                return org.aspose.cells_foss.core.AutoFilterModel.FilterOperatorType.GREATER_THAN;
            default:
                return org.aspose.cells_foss.core.AutoFilterModel.FilterOperatorType.EQUAL;
        }
    }
     ...
     */
    public static boolean tryParseOperator(String value, org.aspose.cells_foss.core.AutoFilterModel.FilterOperatorType[] operatorType) {
        operatorType[0] = org.aspose.cells_foss.core.AutoFilterModel.FilterOperatorType.EQUAL;
        // Handle the relevant branch before the state changes.
        if (value == null || value.isBlank()) {
            return true;
        }
        ...
        switch (trimmed) {
            case "lessThan":
                operatorType[0] = org.aspose.cells_foss.core.AutoFilterModel.FilterOperatorType.LESS_THAN;
                return true;
            case "lessThanOrEqual":
                operatorType[0] = org.aspose.cells_foss.core.AutoFilterModel.FilterOperatorType.LESS_OR_EQUAL;
                return true;
            case "notEqual":
                operatorType[0] = org.aspose.cells_foss.core.AutoFilterModel.FilterOperatorType.NOT_EQUAL;
                return true;
            case "greaterThanOrEqual":
                operatorType[0] = org.aspose.cells_foss.core.AutoFilterModel.FilterOperatorType.GREATER_OR_EQUAL;
                return true;
            case "greaterThan":
                operatorType[0] = org.aspose.cells_foss.core.AutoFilterModel.FilterOperatorType.GREATER_THAN;
                return true;
            case "equal":
                operatorType[0] = org.aspose.cells_foss.core.AutoFilterModel.FilterOperatorType.EQUAL;
                return true;
     ...
     */
    public static String toOperatorName(org.aspose.cells_foss.core.AutoFilterModel.FilterOperatorType operatorType) {
     ...
     */
    public static int compareFilterColumns(org.aspose.cells_foss.core.AutoFilterModel.FilterColumnModel left, org.aspose.cells_foss.core.AutoFilterModel.FilterColumnModel right) {
