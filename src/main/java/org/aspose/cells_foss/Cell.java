...
import org.aspose.cells_foss.core.CellRecord;
import org.aspose.cells_foss.core.CellValueKind;
...
public class Cell {
    ...
    public String getDisplayStringValue() {
        CellRecord record = tryGetRecord();
        org.aspose.cells_foss.core.StyleValue style =
                record != null && record.getStyle() != null ? record.getStyle() : org.aspose.cells_foss.core.StyleValue.getDefault();
    ...
    public Style getStyle() {
        CellRecord record = tryGetRecord();
        org.aspose.cells_foss.core.StyleValue sv =
                record != null ? record.getStyle() : org.aspose.cells_foss.core.StyleValue.getDefault();
    ...
    private CellRecord getOrCreateRecord() {
        ...
        return worksheet.getModel().getCells().computeIfAbsent(address, k -> {
            ...
            record.setStyle(new org.aspose.cells_foss.core.StyleValue());
            return record;
        });
    }
