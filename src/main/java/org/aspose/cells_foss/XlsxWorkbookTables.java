...
final class XlsxWorkbookTables {
    ...
    private static void parseRef(String ref, ListObjectModel model) {
        ...
        try {
            org.aspose.cells_foss.core.CellAddress a1 = XlsxWorkbookSerializerCommon.parseRef(parts[0]);
            org.aspose.cells_foss.core.CellAddress a2 = XlsxWorkbookSerializerCommon.parseRef(parts[1]);
