...
import org.aspose.cells_foss.core.MergeRegion;
...
public class Cells {
    ...
    public Cell get(String cellName) {
        ...
        try {
            return new Cell(worksheet, org.aspose.cells_foss.core.CellAddress.parse(cellName));
    ...
    public Cell get(int row, int column) {
        ...
        return new Cell(worksheet, new org.aspose.cells_foss.core.CellAddress(row, column));
    }
