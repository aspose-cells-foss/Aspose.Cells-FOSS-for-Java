...
public final class FormatConditionCollection {
    ...
    public int addCondition(FormatConditionType type, OperatorType operatorType, String formula1, String formula2) {
        ...
        condition.setStyle(org.aspose.cells_foss.core.StyleValue.getDefault().clone());
    ...
    private static void initializeDefaults(FormatConditionModel condition) {
        ...
        switch (condition.getType()) {
            ...
            case COLOR_SCALE:
                ...
                break;
            case DATA_BAR:
                condition.setBarColor(new org.aspose.cells_foss.core.ColorValue((byte) 255, (byte) 99, (byte) 142, (byte) 198));
                break;
            case ICON_SET:
