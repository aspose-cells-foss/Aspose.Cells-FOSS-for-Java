...
public final class XlsxDocumentProperties {
     ...
     */
    public static org.w3c.dom.Document buildCorePropertiesDocument(org.aspose.cells_foss.core.WorkbookModel model) {
     ...
     */
    public static org.w3c.dom.Document buildExtendedPropertiesDocument(org.aspose.cells_foss.core.WorkbookModel model) {
        // Use getDocumentProperties() method from WorkbookModel
        Object docProps = model.getDocumentProperties();
        if (docProps == null) {
            return null;
     ...
     */
    public static void loadDocumentProperties(ZipFile archive, org.aspose.cells_foss.core.WorkbookModel model, LoadDiagnostics diagnostics, LoadOptions options) {
     ...
     */
    private static void loadCoreProperties(ZipFile archive, org.aspose.cells_foss.core.WorkbookModel model, LoadDiagnostics diagnostics, LoadOptions options, String partUri) {
     ...
     * @param partUri part uri
     */
    private static void loadExtendedProperties(ZipFile archive, org.aspose.cells_foss.core.WorkbookModel model, LoadDiagnostics diagnostics, LoadOptions options, String partUri) {
        if (partUri == null || partUri.isEmpty()) {
            return;
        }
