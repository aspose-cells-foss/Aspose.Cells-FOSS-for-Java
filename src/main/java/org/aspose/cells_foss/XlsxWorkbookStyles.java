...
final class XlsxWorkbookStyles {
    ...
    static StyleLoadResult loadStyleValues(Map<String, byte[]> entries) {
        ...
        // Read fills 鈥?4th element is raw XML for fills using theme/tint/indexed colors
        ...
        // Read differential formats (dxfs) 鈥?used by conditional formatting
     ...
     * @return the computed result
     */
    /** Serializes a font element to a complete &lt;font&gt;鈥?lt;/font&gt; XML string, preserving all child elements verbatim. */
    ...
    /** Serializes a patternFill element to a complete <fill>鈥?/fill> XML string, preserving all color attributes verbatim. */
