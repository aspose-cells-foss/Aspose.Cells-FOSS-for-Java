...
import com.aspose.cells_foss.core.PageSetupModel;
...
public final class PageSetup {
    ...
    public void setOrientation(PageOrientationType value) {
        ...
        switch (value) {
            case PORTRAIT:
                model.setOrientation(com.aspose.cells_foss.core.PageOrientation.PORTRAIT);
                break;
            case LANDSCAPE:
                model.setOrientation(com.aspose.cells_foss.core.PageOrientation.LANDSCAPE);
                break;
            default:
                model.setOrientation(com.aspose.cells_foss.core.PageOrientation.DEFAULT);
                break;
        }
    }
