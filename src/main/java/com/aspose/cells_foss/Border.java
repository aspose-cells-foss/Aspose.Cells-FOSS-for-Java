...
public class Border {
     ...
     * @return the computed result
     */
    static Border fromModel(com.aspose.cells_foss.core.BorderSideValue bsv) {
        Border b = new Border();
     ...
     * @return the computed result
     */
    com.aspose.cells_foss.core.BorderSideValue toModel() {
        com.aspose.cells_foss.core.BorderSideValue bsv = new com.aspose.cells_foss.core.BorderSideValue();
     ...
     * @return the computed result
     */
    private static BorderStyleType mapStyle(com.aspose.cells_foss.core.BorderStyle s) {
     ...
     * @return the computed result
     */
    private static com.aspose.cells_foss.core.BorderStyle mapStyleToCore(BorderStyleType s) {
        // Handle the relevant branch before the state changes.
        if (s == null) return null;
        switch (s) {
            case THIN:               return com.aspose.cells_foss.core.BorderStyle.THIN;
            case MEDIUM:             return com.aspose.cells_foss.core.BorderStyle.MEDIUM;
            case THICK:              return com.aspose.cells_foss.core.BorderStyle.THICK;
            case DOTTED:             return com.aspose.cells_foss.core.BorderStyle.DOTTED;
            case DASHED:             return com.aspose.cells_foss.core.BorderStyle.DASHED;
            case DOUBLE:             return com.aspose.cells_foss.core.BorderStyle.DOUBLE;
            case HAIR:               return com.aspose.cells_foss.core.BorderStyle.HAIR;
            case MEDIUM_DASHED:      return com.aspose.cells_foss.core.BorderStyle.MEDIUM_DASHED;
            case DASH_DOT:           return com.aspose.cells_foss.core.BorderStyle.DASH_DOT;
            case MEDIUM_DASH_DOT:    return com.aspose.cells_foss.core.BorderStyle.MEDIUM_DASH_DOT;
            case DASH_DOT_DOT:       return com.aspose.cells_foss.core.BorderStyle.DASH_DOT_DOT;
            case MEDIUM_DASH_DOT_DOT:return com.aspose.cells_foss.core.BorderStyle.MEDIUM_DASH_DOT_DOT;
            case SLANTED_DASH_DOT:   return com.aspose.cells_foss.core.BorderStyle.SLANTED_DASH_DOT;
            default:                 return com.aspose.cells_foss.core.BorderStyle.NONE;
        }
    }
}